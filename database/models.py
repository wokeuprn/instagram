...
class Profile(Base):
    ...
    search_index = relationship("UserSearchIndex", back_populates="profile", uselist=False, cascade="all, delete-orphan")
...
class Post(Base):
    ...
    media_url = sqlalchemy.Column(sqlalchemy.String, nullable=True)
    created_at = sqlalchemy.Column(sqlalchemy.DateTime)
    ...
    search_index = relationship("PostSearchIndex", back_populates="post", uselist=False, cascade="all, delete-orphan")

    @property
    def username(self) -> str:
        return self.profile.username if self.profile else ""

    @property
    def profile_picture(self) -> str:
        return self.profile.profile_picture if self.profile else ""
...
class Reel(Base):
    ...
    search_index = relationship("ReelSearchIndex", back_populates="reel", uselist=False, cascade="all, delete-orphan")
...
class Hashtag(Base):
    ...
    search_index = relationship("HashtagSearchIndex", back_populates="hashtag", uselist=False, cascade="all, delete-orphan")
...
class AudioTrack(Base):
    ...
    search_index = relationship("AudioSearchIndex", back_populates="audio", uselist=False, cascade="all, delete-orphan")
...
class UserSearchIndex(Base):
    ...
    profile = relationship("Profile", back_populates="search_index")
